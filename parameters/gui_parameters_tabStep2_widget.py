...
from gui_common_widgets import ParametersStepTwoWidget
from PyQt5 import QtCore

class TabStepTwoParameterWidget(QWidget):
    def __init__(self, parent):
        ...
        self.ParametersWidget = ParametersStepTwoWidget(self,editingMode = True)
        ...
        # Connexions
        self.ParametersList.itemAdded.connect(self.ParametersManager.AddStep2Parameter)
        self.ParametersList.itemDeleted.connect(self.ParametersManager.DelStep2Parameter)
        ...
        self.ParametersManager.ParamStep2Renamed.connect(self.ParametersList.UpdateANameParameter)
        ...
        # Initialisation
        listParameters = self.ParametersManager.GetListOfStep2Parameters()
    ...
    def buttonSaveClicked(self):
        ...
        if(CurrentItem is not None):
            ...
            if(NewKey != OldKey):
                self.ParametersManager.UpdateNameParameterStep2(OldKey,NewKey)
            self.ParametersManager.ModifyStep2Parameter(NewKey,NewParameters)
